...
TEST(correctness, vietnamese) {
  std::string s = "Tôi xin lỗi vì số lượng lớn bưu kiện trên github";
  EXPECT_EQ(s, encode_decode(s));
}

TEST(correctness, korean) {
  std::string s = "다시는 일어나지 않을 것입니다.";
  EXPECT_EQ(s, encode_decode(s));
}

TEST(correctness, greek) {
  std::string s =
      "Ξέρετε, μερικές φορές αναρωτιέμαι: τι οδηγεί τους ανθρώπους που κάνουν "
      "κάποιες εργασίες στις τρεις το πρωί; Δεν είναι αφύσικο να κάνεις κάτι "
      "εις βάρος του ύπνου; Σε ποιο σημείο της ζωής ενός ανθρώπου ενσταλάζεται "
      "ότι η γνώση είναι πιο σημαντική από την υγεία; Και πώς έφτασε η "
      "ανθρωπότητα σε αυτό το σημείο;\n"
      "\n"
      "Μου φαίνεται ότι φταίει ο ανταγωνισμός για υλικά αγαθά που βασιλεύει "
      "στον κόσμο. Αλλά είναι τρελά λυπηρό που οι άνθρωποι πρέπει να θυσιάσουν "
      "την υγεία τους για να ανέβουν στην κοινωνική σκάλα. Συμφωνείς μαζί μου?";
  EXPECT_EQ(s, encode_decode(s));
}
